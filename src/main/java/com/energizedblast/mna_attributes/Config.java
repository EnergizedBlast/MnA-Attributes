...
public class Config
{
    ...
    public static final ForgeConfigSpec.DoubleValue STARTING_MAX_MANA_MULTIPLIER = BUILDER
            .defineInRange("startingMaxManaMultiplier", 1.0D, 0.0D, 2048.0D);
    public static final ForgeConfigSpec.DoubleValue STARTING_MANA_REGEN = BUILDER
            .defineInRange("startingManaRegenMultiplier", 1.0D, 0.0D, 2048.0D);
    public static final ForgeConfigSpec.DoubleValue STARTING_CAST_SPEED = BUILDER
            .defineInRange("startingCastSpeedMultiplier", 1.0D, 0.0D, 2048.0D);
    public static final ForgeConfigSpec.DoubleValue STARTING_SPELL_DAMAGE = BUILDER
            .defineInRange("startingSpellDamageModifier", 1.0D, 0.0D, 2048.0D);
    ...
    public static final ForgeConfigSpec.DoubleValue STARTING_SPELL_EFFICIENCY = BUILDER
            .defineInRange("startingSpellEfficiencyMultiplier", 1.0D, 0.0D, 2048.0D);

    static final ForgeConfigSpec SPEC = BUILDER.build();

    public static double startingMaxManaModifier;
    public static double startingMaxManaMultiplier;
    public static double startingCastSpeedMultiplier;
    public static double startingSpellDamageModifier;
    public static double startingSpellDamageMultiplier;
    public static double startingSpellEfficiencyMultiplier;
    public static double startingManaRegenMultiplier;
